...
**Current Version:** v10.11.2 - Tag Filtering & Security Hardening (JSON deserialization fix, SQL-level optimization, DoS protection) - see [CHANGELOG.md](CHANGELOG.md) for details
