...
**Current Version:** v10.13.1 - Critical Bug Fixes (tag search limits, REST API field access, metadata corruption, hash display, prompt handler crashes) - see [CHANGELOG.md](CHANGELOG.md) for details
