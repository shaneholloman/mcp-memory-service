...
**Current Version:** v10.43.0 - feat(search): Reciprocal Rank Fusion (RRF) for SQLite-vec hybrid search (PR #773, @filhocf) — ~1,732 tests — see [CHANGELOG.md](CHANGELOG.md) for details
