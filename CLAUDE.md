...
**Current Version:** v10.38.0 - feat: opt-in Claude Code SessionEnd auto-harvest hook (PR #711, issue #631) — 1,547 Python tests + 9 Node.js hook tests — see [CHANGELOG.md](CHANGELOG.md) for details
