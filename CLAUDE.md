...
**Current Version:** v10.11.0 - SQLite Integrity Monitoring (automatic WAL corruption detection/repair, emergency export, 3.5ms overhead) - see [CHANGELOG.md](CHANGELOG.md) for details
