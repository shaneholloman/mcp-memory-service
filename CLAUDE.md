...
**Current Version:** v10.44.0 - feat: Mistake Notes — structured error replay (`mistake_note_add`, `mistake_note_search`, PR #786, @filhocf) — ~1,737 tests — see [CHANGELOG.md](CHANGELOG.md) for details
