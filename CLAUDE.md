...
**Current Version:** v10.42.1 - fix(milvus): missing anns_field in search calls for BM25-enabled collections (PR #775, @henry201605) — ~1,722 tests — see [CHANGELOG.md](CHANGELOG.md) for details
