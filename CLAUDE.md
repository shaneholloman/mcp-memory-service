...
**Current Version:** v10.49.0 - feat(cli): lazy lifecycle commands and faster startup (PR #841, @creativelaides) — ~1,803 tests — see [CHANGELOG.md](CHANGELOG.md) for details
