...
**Current Version:** v10.10.3 - Test Infrastructure & Memory Scoring Fixes (CI pipeline stability, graph visualization validation, test authentication) - see [CHANGELOG.md](CHANGELOG.md) for details
