...
**Current Version:** v10.12.1 - Custom Memory Type Test Fixes (get_all_types() fix, test isolation improvements, 100% ontology test pass rate) - see [CHANGELOG.md](CHANGELOG.md) for details
