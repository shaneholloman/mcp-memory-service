...
**Current Version:** v10.39.1 - hotfix: plugin.json author field object format — unblocks `/plugin install mcp-memory-service` (#738, #739) — 1,547 tests — see [CHANGELOG.md](CHANGELOG.md) for details
