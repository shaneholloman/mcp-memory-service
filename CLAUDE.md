...
**Current Version:** v10.10.6 - Test Infrastructure Improvements (Python 3.11 compatibility, pytest-benchmark re-enabled, coverage baseline established) - see [CHANGELOG.md](CHANGELOG.md) for details
