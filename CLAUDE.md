...
**Current Version:** v10.38.2 - fix(windows): PS 7+ cert bypass, per-call SkipCertificateCheck, chicken-egg lib sourcing (PR #723) — 1,547 tests — see [CHANGELOG.md](CHANGELOG.md) for details
