...
**Current Version:** v10.4.6 - Documentation enhancement clarifying HTTP dashboard authentication requirements (Issue #410, #414) - see [CHANGELOG.md](CHANGELOG.md) for details
